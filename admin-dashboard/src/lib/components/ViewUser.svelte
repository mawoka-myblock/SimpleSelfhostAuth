...
{:then user}
    <div class="pl-2 pb-4">
        <div>
            ...
            <input id="username" type="text" bind:value={userChangeData.username} class="border-b border-dotted border-black"/>
        </div>
        <div>
            <label for="email">Email: </label>
            <input id="email" type="email" bind:value={userChangeData.email} class="border-b border-dotted border-black"/>
        </div>
        <div>
            <label>Admin: </label>
...
<!-- Heroicons: outline/plus -->
                    ...
                    <div class="flex justify-center w-fit">
                        ...
                        >
                            ...
                            >
                                ...
                                <svg class="mx-auto h-6 w-6 fill-current" fill="none" stroke="currentColor"
    ...
    <button on:click={saveData}
        ...
        <svg class="w-5 h-5 pr-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
