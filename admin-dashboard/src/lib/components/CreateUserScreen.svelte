<script lang="ts">
    ...
    const registerSchema = yup.object({
        username: yup.string().required("Username mustn't be empty").min(4, "Username must be longer than 4 characters."),
        email: yup.string().email("Email must be a valid email").required("Email can't be empty"),
        password: yup.string().required("Password mustn't be empty").min(8, "Password must be longer than 8 characters."),
        password2: yup.string().required().test('equal', 'Passwords do not match!', function (v) {
...
<form use:form>
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800" id="username"
                   type="text"
                   name="username"
                   class:border-red-300={$errors.username !== null}
                   class:border-green-400={$touched.username === true &&
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800" id="email"
                   type="email"
                   name="email"
                   class:border-red-300={$errors.email !== null}
                   class:border-green-400={$touched.email === true &&
								$errors.email === null}
                   placeholder="Username">
        </div>
        <div class="mb-6">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 mb-3"
                   ...
                   class:border-green-400={$touched.password === true &&
        ...
        <div class="mb-6">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 mb-3"
                   ...
                   class:border-green-400={$touched.password2 === true &&
								$errors.password2 === null}
                   id="password2" type="password" placeholder="******************">
        </div>

        <div class="flex items-center justify-between">
            <button class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded disabled:opacity-50 disabled:cursor-not-allowed"
                    type="submit"
